...
const createFaq = function (heading, body) {
  ...
  faqHeadingButtonContainer.setAttribute(
    "class",
    "faq-heading-button-container"
  );
...
const signinMainButton = document.getElementById("signin-main-button");
signinMainButton.addEventListener("click", function () {
  signInScreen.setAttribute("class", "sign-in-screen");
});
signInScreen.addEventListener("click", function () {
  signInScreen.setAttribute("class", "sign-in-screen hidden");
});
